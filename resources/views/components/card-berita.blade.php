<div>
    <a href="{{ $link }}"
        class="relative block w-[400px] h-auto font-jakarta bg-transparent rounded-2xl overflow-hidden transition-all group hover:shadow-lg">
        <div
            class="transition duration-200 ease-out absolute inset-0 rounded-2xl border-2 border-transparent {{ $hoverBorder }} group-hover:p-4">
        </div>
