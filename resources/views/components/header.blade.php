    ...
    <nav class="bg-primary100">
        <div class="relative flex h-16 mx-auto px-16 py-9 space-x-5 items-center justify-between w-full">
            ...
            <div class="hidden lg:flex flex-1 justify-center items-center space-x-3" id="menu">
                ...
                <a href="/home" class="rounded-lg px-3 py-2 text-sm font-jakarta font-medium text-white drop-shadow-2xl"
                ...
                <div x-data="{ open: false }" class="relative">
                    <button @click="open = !open"
                        ...
                        <img src="/storage/assets/dropdown.png" alt="Dropdown"
                            class="w-4 h-4 brightness-50 transition duration-200 ease-out rotate group-hover:brightness-100">
                    </button>
                ...
                <a href="https://seleksikpid.jatimprov.go.id/"
                    class="FLEX rounded-md px-3 py-2 font-jakarta text-p font-medium text-gray50 hover:text-white hover:drop-shadow-2lx transition duration-200 ease-out">SELEKSI KPID</a>
            </div>

            <!-- Icons -->
            <div class="hidden lg:flex items-center space-x-9" id="icons">
                <a href="#"><img class="w-5 filter brightness-50 hover:brightness-100 hover:drop-shadow-xl transition duration-50 ease-out"
                ...
                <a href="#"><img class="w-4 filter brightness-50 hover:brightness-100 hover:drop-shadow-xl transition duration-50 ease-out"
