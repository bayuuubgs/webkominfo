<div class="relative w-[404px] h-auto font-jakarta bg-transparent rounded-2xl shadow-md overflow-hidden transition-all group">
    ...
    <div class="relative z-10 bg-transparent p-4 rounded-2xl">
        ...
        <h3 class="text-lg font-bold text-white mt-2 whitespace-normal">{{ $title }}</h3>
        <div class="flex justify-between items-center mt-2">
            <p class="text-sm text-gray-300 font-normal">{{ $date }}</p>
            <x-label-kategori text={{$category}}/>
        </div>
        <p class="text-gray-300 mt-2 text-sm font-normal whitespace-normal">
            {{ $description }}
        </p>
