        ...
        [
            ...
            'hasDropdown' => false
                ...
                <a href="https://seleksikpid.jatimprov.go.id/"
                    class="FLEX rounded-md px-3 py-2 font-jakarta text-p font-medium text-gray50 hover:text-white hover:drop-shadow-2lx transition duration-200 ease-out">SELEKSI
                    KPID</a>
            </div>
