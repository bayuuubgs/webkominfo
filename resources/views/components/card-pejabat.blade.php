<div class="group relative z-10 bg-transparent p-4 rounded-2xl overflow-hidden text-white hover:ring-1 hover:ring-inset hover:ring-primary30 hover:shadow-xl transition-all duration-150">
    <div class="relative w-[240px] h-[320px] p-4 font-jakarta rounded-xl shadow-md overflow-hidden transition-all duration-200 group-hover:shadow-xl">
        ...
        {{-- Content --}}
        <div class="relative z-10 flex flex-col justify-end h-full p-2">
            <p class="text-p text-center font-bold leading-snug uppercase">{{ $name }}</p>
            <p class="text-p text-center mt-1 leading-tight whitespace-normal">
                {{ $position }}
            </p>
        </div>
    </div>
