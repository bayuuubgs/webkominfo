...
@php
    ...
    $variants = [
        'white' => 'bg-gray10 text-primary100 hover:bg-gray30 active:text-gray10 active:bg-secondary50',
        'blue' => 'bg-primary50 text-gray10 hover:bg-primary30 active:text-gray90 active:bg-secondary50',
    ];
