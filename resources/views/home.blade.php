...
<body class="w-full bg-background font-responsive">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 -ml-[50px]">
            <div class="lg:col-span-2 flex flex-col pt-[8px]">
                <x-video-container video-id="s18KVkb4rLE"
                    title="INFO JAWA TIMUR MINGGU KE-4 BULAN MARET I 28 MARET 2025" description="INFO JATIM edisi Minggu ke-4 bulan Maret 2025 menyajikan beragam kegiatan di lingkungan Pemprov Jatim dalam sepekan, di antaranya :
                    1. Kominfo berbagi.
    ...
    <section class="bg-primary100 relative">
        <div class="px-[60px] pb-[8px] pt-[28px]">
            <x-section-header title="Berita Setda/" highlight="Perangkat Daerah" buttonText="Selengkapnya" buttonVariant="white"
    ...
    <section class=" relative">
        <div class="px-[60px] pb-[8px] pt-[28px]">
            <x-section-header title="Berita " highlight="Gubernur" buttonText="Selengkapnya"
                buttonVariant="blue"
            ...
            <swiper-slide class="relative group rounded-xl overflow-hidden transition-all duration-500">
                <a href="home.galerifoto.detail">
                    ...
                    <div
                        ...
                        <p class="text-p font-medium line-clamp-2">
                            Kepala Dinas Komunikasi dan Informatika Provinsi Jawa Timur (sedang berdiri) memberikan
                            arahan dan semangat kepada para atlet cabang
                        </p>
                        <span class="mt-[8px] text-gray10 font-bold underline text-p">Selengkapnya</span>
                    </div>
                </a>
    ...
    <section class="bg-primary100 relative font-jakarta">
        <div class="pl-[60px] pr-[32px] pb-[25px] pt-[28px]">
            <x-section-header title="Majalah " highlight="" buttonText="Selengkapnya" buttonVariant="white" type="white"
