...
<body class="bg-white text-gray-800 font-responsive text-pM lg:text-p">
    ...
    <div class="relative w-full h-[calc(100dvh-126px)] overflow-hidden">
    ...
    <section class="bg-primary100 relative px-10 md:px-16 py-5">
        ...
        ['image' => asset('storage/assets/unitkerja1.jpg'), 'text' => 'Sekretariat', 'link' => '/home/bidangsekretariat', 'alt' => 'Thumbnail Gambar Terkait'],
