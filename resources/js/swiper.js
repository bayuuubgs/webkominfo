...
!(function () {
                ...
                for (let t = 0, i = s.length; t < i; t += 1) {
                    ...
                    void 0 !== r &&
                        ...
                        (p(e[i]) && p(a[i])
                            ...
                            : !p(e[i]) && p(a[i])
                            ? ((e[i] = {}),
                              a[i].__swiper__ ? (e[i] = a[i]) : c(e[i], a[i]))
                            : (e[i] = a[i]));
                }
            }
        }
    ...
    var B = {
        ...
        updateActiveIndex: function (e) {
            ...
            if (
                (o >= i.length && (o = i.length - 1), d === r && !t.params.loop)
            )
                return void (
    ...
    var R = {
        ...
        loopFix: function (e) {
            ...
            p.length < w + y ||
            ("cards" === d.params.effect && p.length < w + 2 * y)
                ? g(
            ...
            let z = 0,
                k = 0;
            const A =
                (x ? p[r].column : r) + (f && void 0 === a ? -w / 2 + 0.5 : 0);
            if (A < y) {
                z = Math.max(y - A, b);
            ...
            breakpoints: {
                setBreakpoint: function () {
                    ...
                    const w = u.direction && u.direction !== a.direction,
                        b =
                            a.loop &&
                            (u.slidesPerView !== a.slidesPerView || w),
                        y = a.loop;
    ...
    const ge = [
        function (e) {
            ...
            function p(e, t, i) {
                ...
                if (t && !o && p > 0) return;
                const { addSlidesBefore: c, addSlidesAfter: u } =
                        s.params.virtual,
                    {
                        from: m,
                        to: h,
                ...
                (y = s.rtlTranslate
                    ...
                    : "top"),
                    l
                        ? ((x = Math.floor(a / 2) + r + u),
                          (E = Math.floor(a / 2) + r + c))
                        : ((x = a + (r - 1) + u), (E = (o ? a : r) + c));
                let S = b - E,
                    T = b + x;
            ...
            function d(e) {
                ...
                if (
                    ...
                    if (
                        ...
                        let e = !1;
                        if (
                            x(t.el, `.${t.params.slideClass}, swiper-slide`)
                                .length > 0 &&
                            0 ===
                                x(t.el, `.${t.params.slideActiveClass}`).length
                        )
                            return;
                        const i = t.el,
                            a = i.clientWidth,
            ...
            s({
                ...
                i("click", (e, s) => {
                    ...
                    if (t.isElement && !l) {
                        ...
                        e &&
                            (l = e.find((e) => i.includes(e) || r.includes(e)));
                    }
                        ...
                        v.imageEl &&
                            ...
                            i.scale > v.maxRatio &&
                                (i.scale =
                                    v.maxRatio -
                                    1 +
                                    (i.scale - v.maxRatio + 1) ** 0.5),
                            i.scale < s.minRatio &&
                                (i.scale =
                                    s.minRatio +
                                    1 -
                                    (s.minRatio - i.scale + 1) ** 0.5),
                ...
                i("touchStart", (e, s) => {
                    t.zoom.enabled &&
                        (function (e) {
                            ...
                            (b.touchesStart.x = i.pageX),
                                (b.touchesStart.y = i.pageY);
                        })(s);
                }),
                i("touchEnd", (e, s) => {
                    t.zoom.enabled &&
            ...
            const E = (e, t, s) => {
                ...
                z = () => {
                    ...
                    (d = r),
                        ...
                        L();
                    let { nextEl: p, prevEl: c } = t.navigation
                        ? t.navigation
                        : {};
                    if (
                        ((p = T(p)),
                ...
                ue({
                    ...
                    setTranslate: () => {
                        ...
                        for (let o = 0; o < e.length; o += 1) {
                            ...
                            d.style.zIndex =
                                -Math.abs(Math.round(p)) + e.length;
    ...
    class Le extends Me {
        ...
        calcSlideSlots() {
            ...
            if (
                ((this.slideSlots = t.length ? Math.max(...t) + 1 : 0),
                this.rendered)
            )
                            ...
                            y &&
                                (t.isElement &&
                                    ((r && "string" != typeof r) ||
                                        ...
                                        (r.innerHTML =
                                            t.hostEl.constructor.nextButtonSvg),
                                    ...
                                    (n && "string" != typeof n) ||
                                        ...
                                        (n.innerHTML =
                                            t.hostEl.constructor.prevButtonSvg),
